...
<section style="padding:2.5rem 0;background:#f8fafc;min-height:80vh;">
    <div class="container" style="max-width:760px;">
        ...
        <div class="card-premium" style="padding:2rem;">
            <form method="POST" action="<?= htmlspecialchars(route('admin.broadcast.send')) ?>">
                <?= csrf_field() ?>
                ...
                <div style="margin-bottom:1.25rem;">
                    ...
                    <input type="text" name="subject" value="<?= htmlspecialchars(old('subject')) ?>" required maxlength="255"
                ...
                <div style="margin-bottom:1.5rem;">
                    ...
                    <textarea name="message" required rows="10"
                              ...
                              style="width:100%;padding:0.7rem 0.85rem;border:1px solid #cbd5e1;border-radius:8px;font-size:0.95rem;font-family:inherit;resize:vertical;"><?= htmlspecialchars(old('message')) ?></textarea>
                </div>
