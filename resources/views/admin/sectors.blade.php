    ...
    <div class="container">
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:1.5rem;flex-wrap:wrap;gap:1rem;">
            <div>
                ...
                <p style="color:#64748b;margin:0.25rem 0 0;">{{ count($sectors) }} sector(s) defined</p>
            </div>
                    ...
                    <ul style="list-style:none;padding:0;margin:0;">
                        @foreach ($sectors as $sec)
                            <li style="padding:0.75rem 0;border-bottom:1px solid #e2e8f0;display:flex;align-items:center;justify-content:space-between;">
                                <div>
                                    <div style="font-weight:600;color:#0f172a;">{{ $sec->name }}</div>
                                    <div style="font-size:0.75rem;color:#64748b;">ID #{{ $sec->id }}</div>
                                </div>
                            </li>
                        @endforeach
                    </ul>
