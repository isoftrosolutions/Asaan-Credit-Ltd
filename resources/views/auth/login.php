<?php $title = 'Log in' ?>
<?php $description = 'Log in to your InvestMatch Nepal account to continue connecting with verified investors and entrepreneurs.' ?>
<?php ob_start() ?>
<section style="padding:3rem 0 5rem;background:#f8fafc;min-height:calc(100vh - 200px);">
    <div class="container" style="max-width:480px;">
        ...
        <div style="background:#fff;border:1px solid #e2e8f0;border-radius:1rem;padding:2.25rem;box-shadow:0 4px 6px -1px rgba(0,0,0,0.05);">
            <form method="POST" action="<?= htmlspecialchars(route('login') ?? '') ?>">
                <?= csrf_field() ?>
        ...
        <p style="text-align:center;color:#64748b;font-size:0.95rem;margin-top:1.5rem;">
            ...
            <a href="<?= htmlspecialchars(route('register') ?? '') ?>" style="color:#c41e3a;font-weight:600;text-decoration:none;">Create one &#8594;</a>
        </p>
    </div>
</section>
