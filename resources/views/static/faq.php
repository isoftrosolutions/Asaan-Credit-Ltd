...
<?php $description = 'Answers to common questions about InvestMatch Nepal — verification, pricing, privacy, and how matching works.' ?>
<?php ob_start() ?>
<?php /* -- HERO -- */ ?>
<section style="background:linear-gradient(135deg,#1e3a8a 0%,#0f1e4d 100%);color:#fff;padding:4rem 0;">
    <div class="container" style="max-width:740px;text-align:center;">
        ...
        <p style="font-size:1.1rem;opacity:0.9;line-height:1.55;">Quick answers to what people ask us most. Can't find what you need? <a href="<?= htmlspecialchars(route('support') ?? '') ?>" style="color:#fff;text-decoration:underline;">Get in touch</a>.</p>
    </div>
</section>
...
<section class="section-premium">
    <div class="container" style="max-width:820px;">
        ...
        <div style="text-align:center;margin-top:3rem;padding:2rem;background:#f8fafc;border-radius:1rem;">
            ...
            <a href="<?= htmlspecialchars(route('support') ?? '') ?>" class="btn btn-primary">Contact our team</a>
        </div>
    </div>
</section>
