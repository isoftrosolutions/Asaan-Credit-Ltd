...
@section('description', 'InvestMatch Nepal — Terms of Service and Privacy Policy. Read about acceptable use, data privacy, verification, and account deletion.')
...
<section style="background:linear-gradient(135deg,#1e3a8a 0%,#0f1e4d 100%);color:#fff;padding:4rem 0;">
    <div class="container" style="max-width:780px;text-align:center;">
        ...
        <p style="opacity:0.85;font-size:0.95rem;">Last updated: {{ now()->format('F j, Y') }}</p>
    </div>
</section>
    ...
    <div class="container" style="max-width:820px;">
        <div style="background:#fff;border:1px solid #e2e8f0;border-radius:1rem;padding:2.5rem;box-shadow:0 1px 2px rgba(0,0,0,0.04);">
            <p style="color:#475569;line-height:1.7;margin-bottom:2rem;">
                Welcome to InvestMatch Nepal. By creating an account, you agree to the terms below. This summary is written in plain language so you can actually read it. If anything is unclear, <a href="{{ route('support') }}" style="color:#c41e3a;font-weight:600;">get in touch</a>.
            </p>
            ...
            @foreach ($sections as $s)
                <div style="margin-bottom:2rem;">
                    <h2 style="font-size:1.2rem;font-weight:700;color:#0f172a;margin-bottom:0.65rem;letter-spacing:-0.015em;">{{ $s['title'] }}</h2>
                    <p style="color:#475569;line-height:1.7;margin:0;">{{ $s['body'] }}</p>
                </div>
            @endforeach
            ...
            <div style="margin-top:2.5rem;padding:1.5rem;background:#f8fafc;border:1px solid #e2e8f0;border-radius:0.85rem;">
                ...
                <p style="color:#475569;margin:0;line-height:1.55;">For legal or privacy inquiries, email <a href="mailto:legal@investmatch.np" style="color:#c41e3a;font-weight:600;">legal@investmatch.np</a> or visit our <a href="{{ route('support') }}" style="color:#c41e3a;font-weight:600;">support page</a>.</p>
            </div>
        </div>
    </div>
</section>
