...
<?php $description = 'Get in touch with the InvestMatch Nepal team — by email, phone, or via the contact form.' ?>
<?php ob_start() ?>
<?php /* -- HERO -- */ ?>
        ...
        <div style="display:grid;grid-template-columns:1.4fr 1fr;gap:2.5rem;align-items:start;">
            ...
            <div style="background:#fff;border:1px solid #e2e8f0;border-radius:1rem;padding:2.25rem;box-shadow:0 1px 2px rgba(0,0,0,0.04);">
                ...
                <form method="POST" action="#">
                    ...
                    <div style="margin-bottom:1.5rem;">
                        ...
                        <textarea id="message" name="message" required rows="6" style="width:100%;padding:0.7rem 0.9rem;border:1px solid #cbd5e1;border-radius:0.5rem;font-size:0.95rem;resize:vertical;font-family:inherit;" placeholder="Tell us what's on your mind&hellip;"></textarea>
                    </div>
            ...
            <div style="display:flex;flex-direction:column;gap:1rem;">
                ...
                <div class="card-premium">
                    ...
                    <p style="font-size:0.85rem;color:#64748b;margin:0;">Sun&ndash;Fri, 10 AM &ndash; 6 PM NPT.</p>
                </div>
